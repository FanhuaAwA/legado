...
| R-P2-002..007 | open                 | lint warnings、番茄/短剧、缓存系统、Harmony 标注、`book` 对象绑定等                                                                                                                         |
...
R-P2-002：按总纲第 56.10.6 节分类处理 lint warnings；`new Function`、书源脚本执行、插件执行等安全边界类 warning 不得粗暴删除，先分组裁决再改代码。
