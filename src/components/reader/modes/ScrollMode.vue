...
function getParagraphCommentSummary(paragraphIndex: number): ParagraphCommentSummary | undefined {
      ...
      <template v-else>
        <p
          ...
          :class="{
            ...
            'scroll-mode__para--has-comment': !!getParagraphCommentSummary(para.index),
          }"
          :style="{
            textIndent: `${textIndent}em`,
            marginBottom: `${paragraphSpacing}px`,
        ...
        >
          <span class="scroll-mode__text" v-html="highlightParagraph(para.text)" />
          <button
          ...
          >
            ...
            <span class="reader-paragraph-comment__count">
              {{ formatParagraphCommentCount(getParagraphCommentSummary(para.index)?.count ?? 0) }}
            </span>
          </button>
        </p>
      </template>
